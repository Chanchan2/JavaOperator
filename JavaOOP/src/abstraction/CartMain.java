...
public class CartMain {
	public static void main(String[] args) {
		TV samsungTV = new TV();
		samsungTV.writeInfo("삼성", "와이드 TV", "123-456", "42 인치", "LED");
		...
		// 인터페이스를 사용하는 이유 2
		// 타입으로 통합을 해야하는 클래스들의 집합이 필요한 상황에서 각각의 클래스를 하나의 컬랙션에 
		// 담는 역할을 한다.
		cart[0] = samsungTV;
		cart[1] = lgNotebook;
		// 배열을 출력할 때는 무조건 for-loop 인데 카트 내부에 있는 객체를
		// 선언해야 할 필요가 존재
	/*	for (int i = 0; i < cart.length; i++) {
			
		}*/
		//이 상황에서는 확장된 for 문이 있는데 그것을 이용

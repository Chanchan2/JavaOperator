...
public class LottoUI extends JFrame implements ActionListener{
	/**
	 * serialVersionUID 는 시리얼 번호로 클래스 구분 식별
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 디버깅 : 프로그램을 구성하는데는 필수적인 소스는 아니지만 에러 발생시
		 에러의 원인을 파악하기 위해 붙여 둔 소스
		 * */
/*		// 6개의 버튼 객체에 아이콘(이미지)을 붙인다.
	...
	// 메소드가 복잡성을 이룰 때 이를 간소화하기 위해서 ALT + SHIFT + M 으로 
	// 메소드 리펙토링을 하는데 지금 상황은 이 리펙토링을 먼저하고 나중에 그 메소드를 완성하는 기법
